...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { latitude: @spot.latitude, longitude: @spot.longitude, time2leave: @spot.time2leave } }
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { latitude: @spot.latitude, longitude: @spot.longitude, time2leave: @spot.time2leave } }
